    ...
    function loadmain(){
        ...
        document.getElementById("sendCard").addEventListener("click", (e) => { openPopup(e, nameCard, wrap); });//명함 전달 클릭
        document.getElementById("apply").addEventListener("click", (e) => { openPopup(e, writePopup, wrap); });
        document.getElementById("listTelNum").addEventListener("click", (e) => { openPopup(e, connectList, wrap); });
