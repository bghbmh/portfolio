...
function image(images ){
	...
	return images.length ? images.map( t => `<img src="${location.href}/data/files/${t.name}" alt="메인이미지">` ).join("") : `<div class="item" title="등록된이미지가없습니다"><i class="icon-svg-image-sharp"></i></div>`;
}
