				...
				e.each(function () {
					var s,
						...
						y = {
							...
							destroy: function () {
								y.verbose("Destroying previous module for", b), b.off(u).removeData(f), y.is.ios() && y.remove.ios(), h.off(a), w.off(a), T.off(a);
							},
							event: {
								clickaway: function (e) {
									var i = 0 < g.find(e.target).length || g.is(e.target),
										n = h.is(e.target);
									i && (y.verbose("User clicked on dimmed page"), y.hide()), n && (y.verbose("User clicked on dimmable context (scaled out page)"), y.hide());
								},
								touch: function (e) {},
							...
							bind: {
								clickaway: function () {
									y.verbose("Adding clickaway events to context", h), c.closable && h.on("click" + a, y.event.clickaway).on("touchend" + a, y.event.clickaway);
								},
								scrollLock: function () {
							...
							refresh: function () {
								y.verbose("Refreshing selector cache"), (h = D(c.context)), (m = h.children(n.sidebar)), (g = h.children(n.pusher)), h.children(n.fixed), y.clear.cache();
							},
								...
								layout: function () {
									0 === h.children(n.pusher).length &&
										...
										(0 !== b.nextAll(n.pusher).length && b.nextAll(n.pusher)[0] === g[0]) ||
											(y.debug("Moved sidebar to correct parent element"), y.error(d.movedSidebar, v), b.detach().prependTo(h), y.refresh()),
										y.clear.cache(),
										y.set.pushable(),
										y.set.direction();
								},
							...
							show: function (e) {
								if (((e = D.isFunction(e) ? e : function () {}), y.is.hidden())) {
									if ((y.refreshSidebars(), c.overlay && (y.error(d.overlay), (c.transition = "overlay")), y.refresh(), y.othersActive()))
							...
							pullPage: function (i) {
								...
								(i = D.isFunction(i) ? i : function () {}),
									...
									y.unbind.scrollLock(),
									(e = function () {
										y.set.transition(t), y.set.animating(), y.remove.visible(), c.dimPage && !y.othersVisible() && g.removeClass(r.dimmed);
									}),
									(n = function (e) {
										e.target == o[0] &&
											(o.off(l + a, n),
							...
							get: {
								direction: function () {
									return b.hasClass(r.top) ? r.top : b.hasClass(r.right) ? r.right : b.hasClass(r.bottom) ? r.bottom : r.left;
								},
								transition: function () {
							...
							debug: function () {
								!c.silent &&
									c.debug &&
									(c.performance ? y.performance.log(arguments) : ((y.debug = Function.prototype.bind.call(console.info, console, c.name + ":")), y.debug.apply(console, arguments)));
							},
							verbose: function () {
								!c.silent &&
									c.verbose &&
									...
									(c.performance
										...
										: ((y.verbose = Function.prototype.bind.call(console.info, console, c.name + ":")), y.verbose.apply(console, arguments)));
							},
							error: function () {
							...
							performance: {
								log: function (e) {
									var i, n;
									c.performance &&
										((n = (i = new Date().getTime()) - (F || i)), (F = i), O.push({Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: v, "Execution Time": n})),
